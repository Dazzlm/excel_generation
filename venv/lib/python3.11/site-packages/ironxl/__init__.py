...
if platform.system() == "Windows":
   ...
   root = "/home/csas09/Downloads/py/venv/IronXLNet"
   print('Checking directory "' + root +'"')
   if not os.path.exists(os.path.join(root, "IronXLNet", "IronXL.dll")):
      root = "/usr/local"
      print('Checking directory "' + root +'"')
...
root = "/home/csas09/Downloads/py/venv/IronXLNet"
print('DEBUG - forced root path:', root)
if not os.path.exists(os.path.join(root, "IronXL.dll")):
...
clr.AddReference(os.path.join(root, "IronXL.dll"))
# import .net types
